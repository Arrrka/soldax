  ...
  return (
    <div className="ton-disconected-custom-block flex-space-between-style">
      <div className="flex-center-style flex-column-content-style">
        ...
        <div className="text-white-middle">{shortenAddress(wallet.account.address)}</div>
      </div>
      <button className="flex-center-style ton-connect-custom-button" style={{ width: 120, height: 40 }} onClick={handleDisconnect}>
        Disconnect
      </button>
    </div>
  );
